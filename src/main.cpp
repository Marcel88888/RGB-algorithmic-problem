...
int main() {
    doTimeTest(SortingAlgorithms::NaiveSorting, 1000, 125, 30,
               "naiveSorting.txt");
    doTimeTest(SortingAlgorithms::InitialTripleSearch, 999, 501, 30,
               "initialTripleSearch.txt");
    doTimeTest(SortingAlgorithms::AdvancedSort, 999, 249, 30,
               "advancedSort.txt");
    doTimeTest(SortingAlgorithms::BreadthSearch, 7, 1, 10,
               "breadthSearch.txt");
    return 0;
}